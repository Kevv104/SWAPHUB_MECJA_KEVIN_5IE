...
--
-- Host: localhost
-- Creato il: Apr 19, 2026 alle 17:33
...
INSERT INTO `Categoria` (`NomeCategoria`, `tenant_id`, `Descrizione`, `dataUltimaMod`) VALUES
('Abbigliamento', 1, 'Vestiti, scarpe e accessori di moda vintage e moderni', '2026-03-29 13:52:47'),
('Casa', 1, 'Arredamento e oggettistica per interni', '2026-03-29 20:52:44'),
('Casa e Giardino', 1, 'Mobili, elettrodomestici e attrezzi vari', '2026-03-29 13:52:47'),
('Collezionismo', 1, 'Monete, francobolli, carte e oggetti rari', '2026-03-29 13:52:47'),
('Elettronica', 1, 'Smartphone, PC, Console e accessori tecnologici', '2026-03-29 13:52:47'),
('Libri', 1, 'Romanzi, manuali e fumetti', '2026-03-29 20:52:44'),
('Sport', 1, 'Attrezzatura tecnica e abbigliamento sportivo', '2026-03-29 20:52:44'),
('Veicoli', 1, 'Auto, moto, biciclette e monopattini', '2026-03-29 13:52:47');
...
INSERT INTO `Chat` (`idChat`, `tenant_id`, `nome`, `stato`, `dataCreazione`, `numPartecipanti`, `descrizione`, `tipoChat`, `idScambio`) VALUES
(1, 1, 'Chat con Pietro', 'attiva', '2026-03-10 10:00:00', 2, 'Discussione su possibile scambio', 'privata', NULL),
(2, 1, 'Amanti del Vintage', 'attiva', '2026-03-01 14:00:00', 2, 'Gruppo per appassionati di oggetti vintage', 'gruppo', NULL),
(3, 1, 'Scambio Completato', 'archiviata', '2026-02-15 09:00:00', 2, 'Chat per scambio già concluso', 'scambio', NULL),
(4, 1, 'Chat con morandi', 'attiva', '2026-03-15 21:45:01', 2, 'chat sanremese', 'privata', NULL),
(5, 1, 'chatTest', 'attiva', '2026-03-29 13:36:18', 2, 'test', 'privata', NULL),
(7, 1, 'prova', 'attiva', '2026-04-10 06:37:28', 2, '4', 'privata', NULL);
...
INSERT INTO `Consegna` (`idConsegna`, `tenant_id`, `idScambio`, `idCorriere`, `dataEstCons`, `stato`, `infoAggiuntive`) VALUES
(1, 1, 3, 'corriere_fedex', NULL, 'in_transito', 'Spedizione presa in carico dalla filiale di Firenze. Consegna prevista a breve.');
...
INSERT INTO `Messaggi` (`idMessaggio`, `tenant_id`, `idChat`, `User`, `contenuto`, `dataInvio`) VALUES
(1, 1, 1, 'gianno', 'Ciao Pietro! Interessato allo scambio?', '2026-03-10 10:05:00'),
(2, 1, 1, 'pietro', 'Ciao! Sì, dimmi di più', '2026-03-10 10:10:00'),
(3, 1, 1, 'gianno', 'Ho visto che hai una bici vintage', '2026-03-10 10:15:00'),
(4, 1, 1, 'pietro', 'Esatto! Cosa proponi in cambio?', '2026-03-14 15:30:00'),
(5, 1, 2, 'gianno', 'Benvenuti nel gruppo!', '2026-03-01 14:10:00'),
(6, 1, 2, 'pietro', 'Grazie! Felice di far parte del gruppo', '2026-03-01 14:15:00'),
(7, 1, 2, 'gianno', 'Ho appena trovato una macchina da scrivere del 1950!', '2026-03-05 18:00:00'),
(8, 1, 2, 'pietro', 'Wow! Foto?', '2026-03-05 18:05:00'),
(9, 1, 3, 'gianno', 'Scambio completato con successo!', '2026-02-15 09:05:00'),
(10, 1, 3, 'pietro', 'Perfetto! Grazie mille', '2026-02-15 09:10:00');
...
INSERT INTO `PartecipaChat` (`idChat`, `tenant_id`, `User`, `dataAdesione`) VALUES
(1, 1, 'gianno', '2026-03-10 10:00:00'),
(1, 1, 'pietro', '2026-03-10 10:00:00'),
(2, 1, 'gianno', '2026-03-01 14:00:00'),
(2, 1, 'pietro', '2026-03-01 14:05:00'),
(3, 1, 'gianno', '2026-02-15 09:00:00'),
(3, 1, 'pietro', '2026-02-15 09:00:00'),
(4, 1, 'gianno', '2026-03-15 21:45:01'),
(4, 1, 'pietro', '2026-03-15 21:45:01'),
(5, 1, 'gianno', '2026-03-29 13:36:18'),
(5, 1, 'pietro', '2026-03-29 13:36:18'),
(7, 1, 'chiara_style', '2026-04-10 06:37:28'),
(7, 1, 'gianno', '2026-04-10 06:37:28');
...
INSERT INTO `Prodotto` (`idProdotto`, `tenant_id`, `Titolo`, `Descrizione`, `Disponibilità`, `img`, `dataPubblicazione`, `Condizioni`, `User`, `NomeCategoria`) VALUES
(1, 1, 'iPhone 13 Pro', 'Tenuto benissimo, batteria 90%, completo di scatola.', 'disponibile', 'uploads/prod/iphone.jpg', '2026-03-29 13:52:47', 'Eccellente', 'gianno', 'Elettronica'),
(2, 1, 'Giacca di pelle Vintage', 'Taglia L, anni 80, vera pelle. Perfetta per la moto.', 'disponibile', 'uploads/prod/giacca.jpg', '2026-03-29 13:52:47', 'Buono', 'sara_vintage', 'Abbigliamento'),
(3, 1, 'PS5 con 2 controller', 'Come nuova, usata pochissimo causa mancanza di tempo.', 'in_scambio', 'uploads/prod/ps5.jpg', '2026-03-29 13:52:47', 'Eccellente', 'pietro', 'Elettronica'),
(4, 1, 'Macchina da scrivere Olivetti', 'Funzionante ma da pulire, nastro da cambiare.', 'scambiato', 'uploads/prod/olivetti.jpg', '2026-03-29 13:52:47', 'Discreto', 'sara_vintage', 'Collezionismo'),
(5, 1, 'Bici da corsa', 'Telaio in carbonio, ruote nuove, usata pochissimo.', 'scambiato', 'uploads/prod/bici.jpg', '2026-03-29 13:52:47', 'Buono', 'gianno', 'Veicoli'),
(6, 1, 'Smartphone Rotto', 'Si accende ma lo schermo è distrutto.', 'disponibile', 'uploads/prod/rotto.jpg', '2026-03-29 13:52:47', 'Guasto', 'bad_user99', 'Elettronica'),
(7, 1, 'Enciclopedia Treccani', 'Collezione completa, ottime condizioni.', 'disponibile', 'uploads/prod/default.jpg', '2026-03-29 20:55:36', 'Eccellente', 'elena_books', 'Libri'),
(8, 1, 'Racchetta da Tennis', 'Modello professionale, usata poco.', 'disponibile', 'uploads/prod/default.jpg', '2026-03-29 20:55:36', 'Buono', 'marco_sport', 'Sport'),
(9, 1, 'Vaso in Ceramica', 'Vaso decorativo fatto a mano.', 'disponibile', 'uploads/prod/default.jpg', '2026-03-29 20:55:36', 'Eccellente', 'chiara_style', 'Casa'),
(10, 1, 'Zaino Trekking', 'Capienza 60L, perfetto per escursioni.', 'disponibile', 'uploads/prod/default.jpg', '2026-03-29 20:55:36', 'Buono', 'marco_sport', 'Sport'),
(11, 1, 'Manga One Piece 1-10', 'Primi dieci volumi della serie.', 'disponibile', 'uploads/prod/default.jpg', '2026-03-29 20:55:36', 'Discreto', 'elena_books', 'Libri'),
(12, 1, 'Lampada Design', 'Lampada da tavolo anni 70.', 'disponibile', 'uploads/prod/default.jpg', '2026-03-29 20:55:36', 'Buono', 'chiara_style', 'Casa');
...
INSERT INTO `Recensioni` (`idRecensione`, `tenant_id`, `idScambio`, `UserRecensore`, `rating`, `commento`, `infoAggiuntive`) VALUES
(1, 1, 2, 'sara_vintage', 5, 'Gianno è super affidabile! La bici è perfetta.', '2026-03-29 13:52:47'),
(2, 1, 2, 'gianno', 4, 'Ottimo scambio, la macchina da scrivere è un bel pezzo da collezione.', '2026-03-29 13:52:47');
...
INSERT INTO `RichiesteAmicizia` (`idRichiesta`, `tenant_id`, `UserMittente`, `UserDestinatario`, `commento`, `dataInvio`, `stato`) VALUES
(1, 1, 'gianno', 'pietro', '', '2026-03-16 08:33:02', 'accettata'),
(2, 1, 'sara_vintage', 'gianno', 'Ciao! Mi piacciono i tuoi articoli vintage.', '2026-03-29 13:52:47', 'inviata'),
(3, 1, 'bad_user99', 'pietro', '', '2026-03-29 13:52:47', 'rifiutata'),
(4, 1, 'elena_books', 'gianno', 'Ciao Gianni, mi interessano i tuoi articoli!', '2026-03-29 20:55:36', 'inviata'),
(5, 1, 'marco_sport', 'gianno', 'Vorrei scambiare la mia racchetta con qualcosa di tuo.', '2026-03-29 20:55:36', 'inviata'),
(6, 1, 'chiara_style', 'gianno', 'Complimenti per il profilo vintage!', '2026-03-29 20:55:36', 'inviata');
...
INSERT INTO `Scambio` (`idScambio`, `tenant_id`, `idProdottoMit`, `idProdottoDest`, `idUtenteMit`, `idUtenteDest`, `dataInizio`, `dataFine`, `stato`) VALUES
(1, 1, 3, 1, 'pietro', 'gianno', '2026-03-29 13:52:47', NULL, 'proposto'),
(2, 1, 4, 5, 'sara_vintage', 'gianno', '2026-03-29 13:52:47', NULL, 'completato'),
(3, 1, 2, 6, 'sara_vintage', 'bad_user99', '2026-03-29 13:52:47', NULL, 'in_consegna'),
(4, 1, 1, 7, 'gianno', 'elena_books', '2026-03-29 20:55:36', NULL, 'proposto');
...
INSERT INTO `Segnalazioni` (`idSegnalazione`, `tenant_id`, `UserSegnalazione`, `Tipo`, `idProdotto`, `idMessaggioSegnalato`, `UserSegnalato`, `idModeratore`, `priorità`, `commento`, `stato`, `dataInvio`) VALUES
(1, 1, 'sara_vintage', 'prodotto', 6, NULL, 'bad_user99', NULL, 'media', 'L\'utente carica solo oggetti rotti e invia spam nelle chat.', 'aperta', '2026-03-29 13:52:47'),
(2, 1, 'gianno', 'utente', NULL, NULL, 'bad_user99', 'mod_luigi', 'alta', 'Mi ha chiesto soldi fuori dalla piattaforma per concludere lo scambio.', 'in_gestione', '2026-03-29 13:52:47'),
(3, 1, 'pietro', 'utente', NULL, NULL, 'bad_user99', NULL, 'urgente', 'Minacce in chat privata dopo che ho rifiutato uno scambio.', 'escalated', '2026-03-29 13:52:47');
...
INSERT INTO `SwapPlus` (`idAbbonamento`, `tenant_id`, `user`, `dataInizio`, `dataFine`) VALUES
(2, 1, 'gianno', '2026-01-01', '2027-01-01'),
(3, 1, 'pietro', '2026-03-15', '2027-03-15');
...
CREATE TABLE `Tenant` (
  `id` int(11) NOT NULL,
  `nome_tenant` varchar(100) NOT NULL,
...
INSERT INTO `Tenant` (`id`, `nome_tenant`, `city`, `is_active`, `created_at`, `updated_at`) VALUES
(1, 'bergamo', 'Bergamo', 1, '2026-04-17 10:01:33', '2026-04-17 10:01:33'),
(2, 'milano', 'Milano', 1, '2026-04-17 10:01:33', '2026-04-17 10:01:33'),
(3, 'torino', 'Torino', 1, '2026-04-17 10:01:33', '2026-04-17 10:01:33');
...
INSERT INTO `utenti` (`username`, `tenant_id`, `password`, `salt`, `bgcolor`, `Nome`, `Cognome`, `Email`, `localita`, `fotoprofilo`, `DataCreazioneProf`, `NomeAzienda`, `isBanned`, `suspendedUntil`) VALUES
('admin_boss', 1, 'eb7f625bb67ba078cdd655ce48e98a2467b5502168e3a29dfd962f2ff3a52cbb', 'd09095bba1782bbc987a5bd4cd67e86a', 'ff0000', 'Mario', 'Rossi', 'admin@swaphub.it', 'Roma, Italia', 'uploads/profile/default.png', '2026-03-29 13:52:47', NULL, 0, NULL),
('bad_user99', 1, 'eb7f625bb67ba078cdd655ce48e98a2467b5502168e3a29dfd962f2ff3a52cbb', 'd09095bba1782bbc987a5bd4cd67e86a', '333333', 'Giacomo', 'Truffi', 'truffa@swaphub.it', 'Torino, Italia', 'uploads/profile/default.png', '2026-03-29 13:52:47', NULL, 0, NULL),
('chiara_style', 1, 'eb7f625bb67ba078cdd655ce48e98a2467b5502168e3a29dfd962f2ff3a52cbb', 'd09095bba1782bbc987a5bd4cd67e86a', 'ffcc00', 'Chiara', 'Neri', 'chiara@email.it', 'Napoli, Italia', 'uploads/profile/default.png', '2026-03-29 20:55:36', NULL, 0, NULL),
('corriere_fedex', 1, 'eb7f625bb67ba078cdd655ce48e98a2467b5502168e3a29dfd962f2ff3a52cbb', 'd09095bba1782bbc987a5bd4cd67e86a', '0000ff', 'Federico', 'Esposito', 'spedizioni@fedex.it', 'Napoli, Italia', 'uploads/profile/default.png', '2026-03-29 13:52:47', NULL, 0, NULL),
('elena_books', 1, 'eb7f625bb67ba078cdd655ce48e98a2467b5502168e3a29dfd962f2ff3a52cbb', 'd09095bba1782bbc987a5bd4cd67e86a', 'f0f0f0', 'Elena', 'Gialli', 'elena@email.it', 'Bologna, Italia', 'uploads/profile/default.png', '2026-03-29 20:55:36', NULL, 0, NULL),
('gianno', 1, 'a7186a11f5ac8f10d42858e53e86f7c9cdad89cb072d414e117af4115dbaab65', 'd09095bba1782bbc987a5bd4cd67e86a', '8e7e43', 'Gianni', 'Morandi', 'gianni@porte.it', 'Reggio nell\'Emilia, Emilia-Romagna, Italia', 'uploads/profile/default.png', '2026-03-13 11:16:44', NULL, 0, NULL),
('lucia_green', 1, 'pass123', '', '', 'Lucia', 'Verdi', 'lucia@email.it', 'Milano', 'uploads/profile/default.png', '2026-03-29 20:53:05', NULL, 0, NULL),
('marco_sport', 1, 'eb7f625bb67ba078cdd655ce48e98a2467b5502168e3a29dfd962f2ff3a52cbb', 'd09095bba1782bbc987a5bd4cd67e86a', 'a0c0f0', 'Marco', 'Rizzo', 'marco@email.it', 'Palermo, Italia', 'uploads/profile/default.png', '2026-03-29 20:55:36', NULL, 0, NULL),
('mario88', 1, 'pass123', '', '', 'Mario', 'Rossi', 'mario@email.it', 'Roma', 'uploads/profile/default.png', '2026-03-29 20:53:05', NULL, 0, NULL),
('mod_luigi', 1, 'eb7f625bb67ba078cdd655ce48e98a2467b5502168e3a29dfd962f2ff3a52cbb', 'd09095bba1782bbc987a5bd4cd67e86a', '00ff00', 'Luigi', 'Verdi', 'mod@swaphub.it', 'Milano, Italia', 'uploads/profile/default.png', '2026-03-29 13:52:47', NULL, 0, NULL),
('pietro', 1, '79be1b6158f3484e709b2b90656516893725edf1f188e2e10139ec09b72f7192', 'f28827455d85343769b993ff9f6d10fe', '32cd32', 'Pietro', 'Morandi', 'pie@tro.it', 'New York, Stati Uniti d\'America', 'uploads/profile/default.png', '2026-03-15 17:20:52', NULL, 0, NULL),
('roberto_tech', 1, 'pass123', '', '', 'Roberto', 'Bianchi', 'roberto@email.it', 'Torino', 'uploads/profile/default.png', '2026-03-29 20:53:05', NULL, 0, NULL),
('sara_vintage', 1, 'eb7f625bb67ba078cdd655ce48e98a2467b5502168e3a29dfd962f2ff3a52cbb', 'd09095bba1782bbc987a5bd4cd67e86a', 'ff00ff', 'Sara', 'Bianchi', 'sara@swaphub.it', 'Firenze, Italia', 'uploads/profile/default.png', '2026-03-29 13:52:47', NULL, 0, NULL),
('sofia_libri', 1, 'pass123', '', '', 'Sofia', 'Galli', 'sofia@email.it', 'Firenze', 'uploads/profile/default.png', '2026-03-29 20:53:05', NULL, 0, NULL);
...
ALTER TABLE `Chat`
  ...
  ADD KEY `idx_tenant_chat` (`tenant_id`,`idChat`);
...
ALTER TABLE `Messaggi`
  ...
  ADD KEY `idx_tenant_messaggi` (`tenant_id`,`idChat`);
...
ALTER TABLE `Prodotto`
  ...
  ADD KEY `idx_tenant_prodotto` (`tenant_id`,`User`);
...
ALTER TABLE `Scambio`
  ...
  ADD KEY `idx_tenant_scambio` (`tenant_id`,`idUtenteMit`);
...
ALTER TABLE `Tenant`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `nome_tenant` (`nome_tenant`);
...
ALTER TABLE `utenti`
  ...
  ADD KEY `idx_tenant_user` (`tenant_id`,`username`);
...
--
-- AUTO_INCREMENT per la tabella `Tenant`
--
ALTER TABLE `Tenant`
...
--
ALTER TABLE `Categoria`
  ADD CONSTRAINT `Categoria_ibfk_1` FOREIGN KEY (`tenant_id`) REFERENCES `Tenant` (`id`) ON DELETE CASCADE;

--
-- Limiti per la tabella `Chat`
--
ALTER TABLE `Chat`
  ADD CONSTRAINT `Chat_ibfk_1` FOREIGN KEY (`tenant_id`) REFERENCES `Tenant` (`id`) ON DELETE CASCADE,
...
--
ALTER TABLE `Consegna`
  ADD CONSTRAINT `Consegna_ibfk_1` FOREIGN KEY (`tenant_id`) REFERENCES `Tenant` (`id`) ON DELETE CASCADE,
...
--
ALTER TABLE `Messaggi`
  ADD CONSTRAINT `Messaggi_ibfk_1` FOREIGN KEY (`tenant_id`) REFERENCES `Tenant` (`id`) ON DELETE CASCADE;

--
-- Limiti per la tabella `PartecipaChat`
--
ALTER TABLE `PartecipaChat`
  ADD CONSTRAINT `PartecipaChat_ibfk_1` FOREIGN KEY (`tenant_id`) REFERENCES `Tenant` (`id`) ON DELETE CASCADE,
...
ALTER TABLE `Prodotto`
  ...
  ADD CONSTRAINT `Prodotto_ibfk_1` FOREIGN KEY (`tenant_id`) REFERENCES `Tenant` (`id`) ON DELETE CASCADE;

--
-- Limiti per la tabella `Recensioni`
--
ALTER TABLE `Recensioni`
  ADD CONSTRAINT `Recensioni_ibfk_1` FOREIGN KEY (`tenant_id`) REFERENCES `Tenant` (`id`) ON DELETE CASCADE,
...
--
ALTER TABLE `RichiesteAmicizia`
  ADD CONSTRAINT `RichiesteAmicizia_ibfk_1` FOREIGN KEY (`tenant_id`) REFERENCES `Tenant` (`id`) ON DELETE CASCADE,
...
--
ALTER TABLE `Scambio`
  ADD CONSTRAINT `Scambio_ibfk_1` FOREIGN KEY (`tenant_id`) REFERENCES `Tenant` (`id`) ON DELETE CASCADE,
...
ALTER TABLE `Segnalazioni`
  ...
  ADD CONSTRAINT `Segnalazioni_ibfk_1` FOREIGN KEY (`tenant_id`) REFERENCES `Tenant` (`id`) ON DELETE CASCADE,
...
--
ALTER TABLE `SwapPlus`
  ADD CONSTRAINT `SwapPlus_ibfk_1` FOREIGN KEY (`tenant_id`) REFERENCES `Tenant` (`id`) ON DELETE CASCADE,
...
--
ALTER TABLE `utenti`
  ADD CONSTRAINT `utenti_ibfk_1` FOREIGN KEY (`tenant_id`) REFERENCES `Tenant` (`id`) ON DELETE CASCADE;
COMMIT;
