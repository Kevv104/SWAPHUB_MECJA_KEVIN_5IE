 ...
 */
if (session_status() === PHP_SESSION_NONE) { // Avvia sessione se non già avviata
    session_start(['cookie_path' => '/login/']); // Imposta cookie_path per essere accessibile solo sotto /login/
}
